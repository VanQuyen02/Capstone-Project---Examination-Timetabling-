...
public class Individual implements Comparable<Individual> {
    ...
    private double payoffStudent;
    private double payoffInvigilator;
    private double payoffDepartment;

    public GeneticData getGetData() {
        return getData;
    }

    public void setGetData(GeneticData getData) {
        this.getData = getData;
    }

    public double getPayoffStudent() {
        return payoffStudent;
    }

    public void setPayoffStudent(double payoffStudent) {
        this.payoffStudent = payoffStudent;
    }

    public double getPayoffInvigilator() {
        return payoffInvigilator;
    }

    public void setPayoffInvigilator(double payoffInvigilator) {
        this.payoffInvigilator = payoffInvigilator;
    }

    public double getPayoffDepartment() {
        return payoffDepartment;
    }

    public void setPayoffDepartment(double payoffDepartment) {
        this.payoffDepartment = payoffDepartment;
    }
...
//                    System.out.println("Can't choose t");
    ...
    public static void main(String[] args) throws IOException, FileNotFoundException, CsvValidationException {
        ...
        double max_student = 0.0;
        double min_student = 9999;
        double max_i = 0.0;
        double min_i = 9999;
        double max_p = 0.0;
        double min_p = 9999;
